...
@Component
@ConditionalOnProperty(prefix = "ai.providers.ollama", name = "base-url")
public class OllamaProvider implements AiProvider {
    ...
    public OllamaProvider(final OpenAiClient openAiClient, final AiProperties aiProperties) {
    ...
    private AiProperties.ProviderConfig getConfig() {
        return aiProperties.getProviders().get("ollama");
    }
}
